...
class CircularProgress: UIView {
    ...
    */
    ...
    fileprivate func createCircularPath() {
        ...
        let circlePath = UIBezierPath(arcCenter: CGPoint(x: frame.size.width / 3.0, y: frame.size.height / 3.0),
                                      radius: (frame.size.width - 1.5)/2.5, startAngle: CGFloat(-0.5 * Double.pi),
